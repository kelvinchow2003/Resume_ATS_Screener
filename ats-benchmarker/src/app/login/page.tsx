...
// Combined Login + Signup page using Supabase Auth.
// Supports email/password auth with form toggle between modes.
// Reads `?redirectedFrom` query param to redirect after login.
// =============================================================================
...
// -----------------------------------------------------------------------------
// Sub-component: labelled input field with inline error
// -----------------------------------------------------------------------------
function InputField({
  id,
  label,
  ...
  return (
    <div className="space-y-1.5">
      <label
        htmlFor={id}
        className="block text-xs font-semibold text-slate-400 tracking-wider uppercase"
      >
        {label}
      </label>
      <input
...
export default function LoginPage() {
  ...
  // If user is already authed, redirect immediately
  useEffect(() => {
  ...
  function switchMode(next: AuthMode) {
    ...
    setErrors({});
    setSuccessMsg(null);
    // Keep email, clear passwords when switching
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-slate-500">
            {mode === "login"
              ...
              : "Create a free account to start benchmarking."}
          </p>
        </div>
            ...
            {(["login", "signup"] as const).map((m) => (
              <button
                ...
                className={`
                  ...
                  ${
                    mode === m
                      ? "bg-[#1a1f35] text-white shadow-sm"
